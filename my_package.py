...
data2=data.T #dataframe having temperature as index 
data2[data2.columns[:3]]=data2[data2.columns[:3]].interpolate() #missing ln(Kp) values at certain temperatures[2100,2300,2500] are filled
